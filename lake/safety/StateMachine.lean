-- ============================================================================
-- MattLib.Safety.StateMachine — Verified Actuator State Machine
-- ============================================================================
...
import MattLib.Safety.Bounded

namespace MattLib.Safety.StateMachine
...
theorem safety_preserved (s s' : SystemState)
  ...
  | emergency _ =>
    ...
    sorry
  | resetFromEmergency _ _ h_no_load =>
    -- New state is .idle — not moving
    sorry
...
end MattLib.Safety.StateMachine
